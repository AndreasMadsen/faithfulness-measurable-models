...
tar -vc --use-compress-program="pigz -p 4" -f $SCRATCH/ecoroar.tar.gz $SCRATCH/ecoroar/ | tqdm --total $(lfs find $SCRATCH/ecoroar/ | wc -l) > /dev/null
cp $SCRATCH/ecoroar.tar.gz $HOME/project/ecoroar.tar.gz
echo "completed"
