...
def test_masking_special_tokens_kept():
    ...
    for seed in range(100):
        masker_max = RandomFixedMasking(1.0, tokenizer, seed=0)
...
def test_masking_zero():
    ...
    for seed in range(100):
        masker_none = RandomFixedMasking(0.0, tokenizer, seed=0)
