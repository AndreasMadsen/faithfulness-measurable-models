    ...
    if args.stage in ['both', 'plot']:
        ...
        for model_category in ['masking-ratio', 'size']:
            ...
            p = (p9.ggplot(df_epochs, p9.aes(x='history.epoch'))
                ...
                + p9.facet_grid("args.model ~ args.dataset", scales="free_x")
            ...
            p.save(f'{args.persistent_dir}/plots/epoch_by_ms_m-{model_category}.pdf', width=3*6.30045 + 0.2, height=7, units='in')
            p.save(f'{args.persistent_dir}/plots/epoch_by_ms_m-{model_category}.png', width=3*6.30045 + 0.2, height=7, units='in')
