...
if __name__ == "__main__":
    ...
    if args.stage in ['both', 'plot']:
        ...
        for model_category in ['masking-ratio', 'size']:
            ...
            p.save(f'{args.persistent_dir}/plots/masked_performance_by_ms_m-{model_category}.pdf', width=3*6.30045 + 0.2, height=7, units='in')
            p.save(f'{args.persistent_dir}/plots/masked_performance_by_ms_m-{model_category}.png', width=3*6.30045 + 0.2, height=7, units='in')
